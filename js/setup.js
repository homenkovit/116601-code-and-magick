...
openSetupWindowButton.addEventListener('click', openSetupWindow);
closeSetupWindowButton.addEventListener('click', closeSetupWindow);
...
var setFill = function (evt, array) {
  evt.target.style.fill = getRandomElementOfArray(array);
};
setupWizardCoat.addEventListener('click', function (evt) {
  setFill(evt, COAT_COLORS_ARRAY);
});
setupWizardEyes.addEventListener('click', function (evt) {
  setFill(evt, EYES_COLORS_ARRAY);
});
